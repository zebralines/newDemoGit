        ...
        for (var i = 0; i < 5; i++) {
           if(i == 3){
             pageMol.framelist[0][i] = {
                 name: 'frame_transaction',
                 url: 'widget://html/transaction/transaction.html',
             ...
             pageMol.framelist[0][i] = {
                 name: 'frame_tour',
                 url: 'widget://html/tourDIY/tourDIY.html',
                 bgColor: 'rgba(0,0,0,.2)',
                 bounces: false,
                 scrollEnabled: true,
                 vScrollBarEnabled: false,
        ...
        var NVTabBar = api.require('NVTabBar');
         NVTabBar.open({
            ...
            },
            {
                ...
                icon: {
                  normal: 'widget://image/bottomNav1.png',
                  highlight: 'widget://image/bottomNav2.png',
                  selected: 'widget://image/bottomNav2.png',
                },
                title: {
                    text: '拼团',
                    size: 12.0,
            ...
            },
            {
                ...
                icon: {
                  normal: 'widget://image/bottomNav3.png',
                  highlight: 'widget://image/bottomNav4.png',
                  selected: 'widget://image/bottomNav4.png',
                },
                title: {
                    text: 'PT',
                    size: 12.0,
